...
@app.route("/home")
def home():
    return render_template("HomePage.html", testimonials=testimonials)
...
testimonials = [
    {
        "name": "שירי – גבעתיים",
        "text": "האוכל של נגה מבושל מכל הלב, טעים ברמות אחרות עם מרכיבים איכותיים והרבה השקעה ותחושה של בית. גם ארוז מושלם ומומלץ בחום.",
        "stars": 5
    },
    {
        "name": "בני – גבעתיים",
        "text": "המטבח של נגה משלב טעמים חדשים ניחוחות של בית. אוכל ליגת על.",
        "stars": 5
    },
    {
        "name": "יובל – ירושלים",
        "text": "אין על האוכל של המטבח של נגה. טעים, עשיר והכי חשוב איכותי ונקי.",
        "stars": 5
    },
    {
        "name": "סתיו – צור משה",
        "text":
            "היחס במטבח של נגה היה פשוט מושלם  אישי, קשוב ומלא רצון טוב.האוכל היה הכי טעים שאכלתי, ובכלל לא הרגיש ללא גלוטן.בתור צליאקית נהניתי מכל רגע, ואני בטוחה שאחזור שוב ושוב!",
        "stars": 5
    },
    # {
    #     "name": "יניב – צורן",
    #     "text": "המטבח של נגה- אוכל מעולה, מגוון רחב, טעים, טרי, מגיע עד הבית",
    #     "stars": 5
    # },
    {
        "name": "שלומי – תל אביב",
        "text": "המטבח של נוגה- פגשתי את זה במקרה ומאז נשבתי בטעמים באיכות בנדיבות של האוכל שסופק לי ובמהירות שזה הגיע אלי מרגע ההזמנה. לא אגזים אם אומר- בזכות המטבח של נגה אפשר למכור את התנור בבית",
        "stars": 5
    },
    {
        "name": "אור – נתניה",
        "text": "לקוחה קבועה של ״המטבח של נגה״. אוכל ביתי מעולה. טעים, טרי, נקי, אסתטי, מחירים סבירים והכמות יחסית למחיר נדיבה מאוד.",
        "stars": 5
    }
]
